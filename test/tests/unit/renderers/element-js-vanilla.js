import {TemplateElement, BaseElement, html} from '../../../../packages/renderer/lib/element-js/vanilla/stubs/index.js';
import {ElementFactory} from '../../../../packages/renderer/lib/element-js/vanilla/index.js';
...
export default () => {
	describe('Element-js vanilla server renderer test', function () {
		...
		it('injects the current request in the elementjs vanilla element', async () => {
			const component = {
				element: class extends TemplateElement {
