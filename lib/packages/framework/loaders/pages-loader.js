...
const loadSinglePage = async ({
  ...
  if (typeof (pageElement === null || pageElement === void 0 ? void 0 : (_pageElement$prototyp = pageElement.prototype) === null || _pageElement$prototyp === void 0 ? void 0 : _pageElement$prototyp.connectedCallback) === "undefined") {
    markup = await (0, _litHtmlServer.renderToString)(pageElement({
      html: _litHtmlServer.html,
      request,
      response
    }));
