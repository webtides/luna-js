...
var _AttributeParser = require("@webtides/element-js/src/util/AttributeParser");
...
const renderComponent = async ({
  ...
  Object.keys(element.properties()).forEach(key => {
    attributes[(0, _AttributeParser.camelToDash)(key)] = typeof properties[key] === "string" ? properties[key] : JSON.stringify(properties[key]);
  });
