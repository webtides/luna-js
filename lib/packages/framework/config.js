...
const loadSettings = async () => {
  try {
    const settings = (await Promise.resolve(`${_path.default.join(process.cwd(), "moon.config.js")}`).then(s => _interopRequireWildcard(require(s)))).default;
    ...
    settings._generated = {
      pagesDirectory: _path.default.join(settings.buildDirectory, "generated", "pages"),
      componentsDirectory: _path.default.join(settings.buildDirectory, "generated", "pages"),
