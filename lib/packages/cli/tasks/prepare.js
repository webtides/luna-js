...
const copyEmptyMoonConfig = async () => {
  ...
  settings.apisDirectory.forEach(api => _fs.default.mkdirSync(api));
  settings.componentsDirectory.forEach(component => _fs.default.mkdirSync(_path.default.join(component.basePath, component.directory)));

  _fs.default.copyFileSync(_path.default.join(moon.currentDirectory, "packages/cli/tasks", "prepare/page.example.js"), _path.default.join(settings.pagesDirectory[0], "index.js"));
};
