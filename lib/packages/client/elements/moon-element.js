...
exports.isOnServer = exports.default = void 0;

var _StyledElement = require("@webtides/element-js/src/StyledElement");
...
class MoonElement extends _StyledElement.StyledElement {
  constructor(options) {
    super({
      deferUpdate: false,
      shadowRender: false,
  ...
  renderTemplate() {
    ...
    if (typeof template === 'string') {
      ...
      // render via lit-html
      (0, _litHtml.render)(template, this.getRoot(), {
