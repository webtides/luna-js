...
const _global_serverLitHtml_html = serverLitHtml.html;
const _global_serverUnsafeHtml_unsafeHTML = serverUnsafeHtml.unsafeHTML;
...
class MoonElement extends StyledElement {
  ...
  renderTemplate() {
    ...
    if (typeof template === 'string') {
      ...
      // render via lit-html
      serverLitHtml.render(template, this.getRoot(), {
...
export { BaseElement, HOOKS, MoonDownElement, MoonElement, apiRequest, _global_serverLitHtml_html as html, layouts, _global_serverUnsafeHtml_unsafeHTML as unsafeHTML };
