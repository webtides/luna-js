...
export default class ElementRenderer {
    ...
    async buildElementForTemplate({component, attributes = {}, group = 'components', request, response}) {
        attributes["ssr"] = true;
    ...
    async renderComponent({component, attributes = {}, group = 'components', request, response}) {
        ...
        const {element, dynamicProperties} = await this.buildElementForTemplate({ component, attributes, group, request, response });
